...
export default function Overlay({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none flex flex-col justify-center px-4 z-[100]">
      ...
      >
        <h1 className="text-3xl md:text-5xl lg:text-7xl font-medium font-monospace-custom mb-6 text-white drop-shadow-2xl leading-tight inline-flex flex-col items-center gap-6 text-center">
          <span>
            Hello,
            <br />I'm Hari Krishna
          </span>
