    ...
    <section className="relative w-full min-h-screen bg-[#121212] py-32 px-8 md:px-24 z-20">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div 
          ...
          className="mb-24"
        >
          <h2 className="text-6xl md:text-8xl font-black tracking-tighter text-white mb-8 flex items-center gap-6">
            <span className="w-16 h-16 md:w-20 md:h-20 bg-white rounded-full flex items-center justify-center text-[#121212] font-black text-2xl md:text-4xl">
              *
            </span>
            Selected Work
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          {PROJECTS.map((p, i) => (
            <motion.div
              ...
              className="glass p-10 md:p-14 rounded-[2rem] flex flex-col justify-end group hover:bg-white/10 transition-all duration-700 cursor-pointer min-h-[450px] border border-white/5 relative overflow-hidden"
            >
              ...
              <div className="mt-auto relative z-10 flex flex-col h-full justify-end">
                <p className="text-xs md:text-sm font-bold tracking-[0.25em] text-white/50 uppercase mb-4">
                  {p.category}
                </p>
                <h3 className="text-3xl md:text-5xl font-bold text-white mb-6 group-hover:-translate-y-2 transition-transform duration-500 ease-out">
                  {p.title}
                </h3>
